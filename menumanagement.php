...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="logo">
            <h2>
                <?php echo htmlspecialchars($vendorInfo["store_name"]); ?>
            </h2>
                ...
                <div class="modal-body">
                    <form id="addMenuForm">
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="3" id="addItemDescription"
            ...
            <table>
                ...
                <tbody>
                    <?php foreach ($menuItems as $item): ?>
                        <tr data-id="<?= (int) $item['item_id'] ?>" data-name="<?= htmlspecialchars($item['name']) ?>"
                            ...
                            <!-- Thumbnail -->
                            <td>
                                <img class="item-thumb" src="<?= htmlspecialchars($item['image_url']) ?>"
                                    alt="<?= htmlspecialchars($item['name']) ?>" onerror="this.style.background='#EEF2FF'">
                            </td>
                            ...
                            <td>
                                <label class="toggle-label" title="<?= $item['is_enabled'] ? 'Enabled' : 'Disabled' ?>">
                                    <input type="checkbox" <?= $item['is_enabled'] ? 'checked' : '' ?> class="toggle-input">
